...
void Odometry::update(float vel_dt, float linear_vel_x, float linear_vel_y, float angular_vel_z, float orient_Z)
{
    float delta_heading = angular_vel_z * vel_dt; // radians
    float cos_h = cos(orient_Z);
    float sin_h = sin(orient_Z);
